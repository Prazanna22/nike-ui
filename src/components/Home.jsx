            ...
            <div className="sticky top-0 z-20 bg-white ">
                <div className="container mx-auto py-5 px-10 md:px-16">
                    <ul className='flex justify-between items-center'>
                        ...
                        <div className="">
                            <img src="./src/assets/nike.png" alt="Nike Logo" className='w-10' />
                        </div>
                ...
                <div className="container mx-auto py-5 px-10 md:px-16">
                        ...
                        <div className="w-full lg:w-1/2  ">
                            <div className="flex flex-col justify-center items-center">
                                ...
                                <div className='flex justify-center gap-6 sm:gap-10 my-20 relative z-10'>
                                    <img src="./src/assets/5.png" alt="" className='w-16 p-1 sm:w-20 md:w-28 border shadow-[0px_3px_8px_rgba(0,0,0,0.24)] ' onClick={() => handleImage("./src/assets/5.png")} />
                                    <img src="./src/assets/3.png" alt="" className='w-16 p-1 sm:w-20 md:w-28 border shadow-[0px_3px_8px_rgba(0,0,0,0.24)]' onClick={() => handleImage("./src/assets/3.png")} />
                                    <img src="./src/assets/2.png" alt="" className='w-16 p-1 sm:w-20 md:w-28 border shadow-[0px_3px_8px_rgba(0,0,0,0.24)]' onClick={() => handleImage("./src/assets/2.png")} />
                                </div>
                    ...
                    <div className="my-20  " id="Products">
                        ...
                        <div className=" justify-center  grid grid-cols-1 sm:grid-cols-2  lg:grid-cols-4  gap-10 md:gap-20 my-10 ">
                            <div className=' p-3 '>
                                <img src="./src/assets/shoe4.svg" alt="" className='w-96 my-4 ' />
                            ...
                            <div className=' p-3'>
                                <img src="./src/assets/shoe5.svg" alt="" className='w-96 my-4' />
                                <p className='flex items-center font-medium '> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 mr-2 text-[#f72c2c] ">
                                    <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.005Z" clipRule="evenodd" />
                                </svg>4.6</p>
                            ...
                            <div className=' p-3'>
                                <img src="./src/assets/shoe6.svg" alt="" className='w-96 my-4' />
                                <p className='flex items-center font-medium '> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 mr-2 text-[#f72c2c]  ">
                                    <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.005Z" clipRule="evenodd" />
                                </svg>4.8</p>
                            ...
                            <div className=' p-3'>
                                <img src="./src/assets/shoe7.svg" alt="" className='w-96 my-4' />
                                <p className='flex items-center font-medium '> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 mr-2 text-[#f72c2c] ">
                                    <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.005Z" clipRule="evenodd" />
                                </svg>4.5</p>
                    ...
                    <div className="mx-auto">
                        <div className="  grid grid-cols-1 sm:grid-cols-2 justify-center items-center mt-20 ">
                            ...
                            <div className="flex justify-center sm:justify-end  ">
                                <img src="./src/assets/shoe8.svg" alt="" className='w-96' />
                            </div>
                        </div>
                        <div className=" justify-center justify-items-center  grid grid-cols-1  lg:grid-cols-3  my-20">
                            <div className="shadow-[0px_3px_8px_rgba(0,0,0,0.24)] w-full lg:w-72 p-5 my-6 mr-0 lg:mr-32">
                                <div className="  bg-red-500 inline-block p-2 rounded-full">
                                    <img src="./src/assets/fast-delivery.png" alt="" className='w-4 ' />
                                </div>
                            ...
                            <div className="shadow-[0px_3px_8px_rgba(0,0,0,0.24)] w-full lg:w-72  my-6 p-5 ">
                                <div className="  bg-red-500 inline-block p-2 rounded-full">
                                    <img src="./src/assets/secure-payment.png" alt="" className='w-4 ' />
                                </div>
                            ...
                            <div className="shadow-[0px_3px_8px_rgba(0,0,0,0.24)] w-full lg:w-72 p-5 ml-0 my-6 lg:ml-32">
                                <div className="  bg-red-500 inline-block p-2 rounded-full">
                                    <img src="./src/assets/heart.png" alt="" className='w-4 ' />
                                </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 items-center justify-center" id='Offers'>
                        <div className="order-2 sm:order-1">
                            <img src="./src/assets/offer.svg" alt="" className='w-[600px]' />
                        </div>
                ...
                <div className="mt-20 bg-[#eeeeee] py-5 px-10 md:px-28 w-full">
                    ...
                    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 justify-center my-10 px-4">
                        <div className="flex flex-col items-center text-center">
                            <img src="./src/assets/customer1.jpeg" alt="" className='w-32 rounded-full my-4' />
                        ...
                        <div className="flex flex-col items-center text-center">
                            <img src="./src/assets/customer2.svg" alt="" className='w-32 rounded-full my-4' />
